...
function wcbox_get_woo_tags()
{
	$wp_tag = get_terms( 'product_tag' , array('hide_empty' => true ));
...
function vp_get_posts()
{
	$wp_posts = get_posts(array(
		'posts_per_page' => -1,'post_type' => 'product'
	));
...
function wcbox_get_effect() {
	$socmeds = array(

		array('value' => 'FadeDown', 'label' => 'FadeDown'),
		array('value' => 'FadeLeft', 'label' => 'FadeLeft'),
